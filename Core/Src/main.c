...
int main(void)
{
  ...
  while (1)
  {
    for(i=0;i<15;i++){
      ...
      if (button_release(GPIOA, botao_Pin,0)){
         contagem++;
         contagem&=0b00011111;
         HAL_GPIO_WritePin(GPIOB,led1_Pin,(contagem>>0)&1);
         HAL_GPIO_WritePin(GPIOB,led2_Pin,(contagem>>1)&1);
         HAL_GPIO_WritePin(GPIOB,led3_Pin,(contagem>>2)&1);
         HAL_GPIO_WritePin(GPIOB,led4_Pin,(contagem>>3)&1);
         HAL_GPIO_WritePin(GPIOB,led5_Pin,(contagem>>4)&1);
